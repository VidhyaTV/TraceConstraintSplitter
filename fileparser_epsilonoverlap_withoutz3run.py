...
#batchlength_array=[2000, 2500, 4000];
#batchlength_array=[5000, 8000, 10000];
#batchlength_array=[20000, 25000, 40000];
#batchlength_array=[50000, 100000, 200000];
				...
				#{
									...
									#{
										...
										#{
											...
											#{
												...
												#{
													constraint1=line;
													constraint1=constraint1.replace(str(actualendlinconstraint),str(((xminusbpluseps)*highestcvalueplusone)+highestcvalueplusone));
													for createdfile in files_in_new_folder_name:
													#{
										...
										#{
											...
											#{
												...
												if ((xminusbeps) >= 0 ):
													constraint1=line;
													constraint1=constraint1.replace(str(actualendlinconstraint),str(((xpluseps)*highestcvalueplusone)+highestcvalueplusone));
													for createdfile in files_in_new_folder_name:
													#{
														if((from_xminusbeps in createdfile) and (to_xpluseps in createdfile)):
														#{
                    ...
                    #{
						...
						#{
							...
							#{
								upperbound=(int(upperbound)*highestcvalueplusone)+highestcvalueplusone;
